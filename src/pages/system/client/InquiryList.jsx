          ...
          <div className="flex w-full flex-col gap-6">
            ...
            <div className="flex gap-4">
              <div className="w-[560px]">
                <span className="text-sm font-medium">담당 부서</span>
              </div>
              <div className="flex-1">
                <span className="text-sm font-medium">담당 유형</span>
              </div>
            </div>
            ...
            <div className="flex w-full flex-wrap items-end gap-4">
              <div className="flex w-full gap-18">
                <div className="flex w-[500px] flex-col">
                  <span className="mb-1 text-sm font-medium">담당자명</span>
                  <Input
                    id={nameId}
                ...
                <div className="flex min-w-[230px] flex-col">
                  <span className="text-sm font-medium">담당자 아이디</span>
                  <div className="fle mt-[5px]">
                    <Input
                      className="w-65"
                      id={nameId}
                      value={searchFilter.name}
